...
INNEFICIENT_DRIVING_LIMIT = 400
OVER_EFFICIENT_DRIVING_LIMIT = 250
    ...
    def updateBarPosition(self):
        try:
            ...
            if (self.tempCounter > INNEFICIENT_DRIVING_LIMIT):
                ...
                self.canvas.itemconfigure(self.efficiencyBar, fill="green")
            else:
...
if __name__ == "__main__":
    root = Tk()
    testBar = EfficiencyBar(root)
    testBar.updateBarPosition()
    root.mainloop()