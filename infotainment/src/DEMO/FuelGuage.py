...
class Display():
	def __init__(self):
		...
		# self.current_speed_label = ttk.Label(self.mainframe3, textvariable=self.current_speed, width=3, font="Helvetica 36 bold")
		# self.current_speed_label.grid(column=0, row=1, sticky=(E))
		# self.current_speed_text_label = ttk.Label(self.mainframe3, text="KPH", font="Helvetica 10 bold")
