...
class CAN_Main(object):
	...
	#engine coolant temp
	def set_engine_coolant_temp(pValue):
	...
	#throttle percent
	def set_throttle_percent(pValue):
	...
	def set_warning_ess_overtemp(pValue):
	...
	def set_warning_fuel_level_low(pValue):
	...
	def set_warning_glv_cockpit_brb(pValue):
	...
	#warning glv soc low
	def set_warning_glv_soc_low(pValue):
	...
	def set_warning_motor_over_temp(pValue):
	...
	def set_warning_transmission_failure(pValue):
	...
	def set_current_control_mode(pValue):
	...
	def set_engery_budget_status(pValue):
